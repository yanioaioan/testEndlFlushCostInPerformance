#############################################################################
# Makefile for building: tmp
# Generated by qmake (3.0) (Qt 5.5.0)
# Project:  tmp.pro
# Template: app
# Command: /opt/qt/5.5/gcc_64/bin/qmake -spec linux-g++ CONFIG+=debug -o Makefile tmp.pro
#############################################################################
...
INCPATH       = -I. -I/opt/qt/5.5/gcc_64/include -I/opt/qt/5.5/gcc_64/include/QtGui -I/opt/qt/5.5/gcc_64/include/QtCore -I. -I/opt/qt/5.5/gcc_64/mkspecs/linux-g++
...
COMPRESS      = gzip -9f
DISTNAME      = tmp1.0.0
DISTDIR = /home/yioannidis/QtStuff/Projects/testEndlFlushCostInPerformance/.tmp/tmp1.0.0
LINK          = g++
...
SOURCES       = testEndlPerformance.cpp 
OBJECTS       = testEndlPerformance.o
DIST          = ../../../.qmake.stash \
		tmp.pro  testEndlPerformance.cpp
QMAKE_TARGET  = tmp
...
Makefile: tmp.pro ../../../.qmake.cache /opt/qt/5.5/gcc_64/mkspecs/linux-g++/qmake.conf /opt/qt/5.5/gcc_64/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec linux-g++ CONFIG+=debug -o Makefile tmp.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents testEndlPerformance.cpp $(DISTDIR)/
...
testEndlPerformance.o: testEndlPerformance.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o testEndlPerformance.o testEndlPerformance.cpp
